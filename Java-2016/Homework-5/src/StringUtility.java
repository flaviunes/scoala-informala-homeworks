...
public class StringUtility {
	...
	public String replaceWordsWithDigits(String s) {
		...
		while (containsDigit(lowerString, "one")) {
		...
		while (containsDigit(lowerString, "two")) {
		...
		while (containsDigit(lowerString, "three")) {
		...
		while (containsDigit(lowerString, "four")) {
		...
		while (containsDigit(lowerString, "five")) {
		...
		while (containsDigit(lowerString, "six")) {
		...
		while (containsDigit(lowerString, "seven")) {
		...
		while (containsDigit(lowerString, "eight")) {
		...
		while (containsDigit(lowerString, "nine")) {
		...
		while (containsDigit(lowerString, "zero")) {
