...
public class Main {
	...
	public static void main(String[] args) {
		...
		Package package8 = new Package("Oradea", 150.16, 40.3, LocalDate.of(2017, 3, 25));
		...
		Package package9 = new Package("Oradea", 130, 71.89, LocalDate.of(2017, 3, 13));
		...
		po.addPackage(package8);
		po.addPackage(package9);
